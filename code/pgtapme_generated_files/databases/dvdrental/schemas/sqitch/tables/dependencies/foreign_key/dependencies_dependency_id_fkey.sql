BEGIN;
  ...
  SELECT fk_ok('sqitch', 'dependencies', ARRAY['dependency_id']::TEXT[], 'sqitch', 'changes', ARRAY['change_id']::TEXT[], 'Foreign key sqitch.dependencies.dependencies_dependency_id_fkey should exist.');
