...
BEGIN
    ...
    ELSIF ( AGE( end_date, start_date ) != '6 days' )
    THEN
        RAISE EXCEPTION 'Must have 7 days! %', age( end_date, start_date );
    END IF;
    ...
    LOOP
        INSERT INTO pgtapme.lkp_dow (
            int_iso_day_of_week_number, int_day_of_week_number, is_weekend, is_weekday,
            ...
            _rec.int_iso_day_of_week_number, _rec.int_day_of_week_number, _rec.is_weekend, _rec.is_weekday,
