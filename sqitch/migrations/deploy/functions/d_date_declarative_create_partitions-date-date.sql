-- Deploy pgtapme_dev:functions/d_date_declarative_create_partitions to pg
-- requires: appschema
-- requires: tables/d_date_declarative

BEGIN;

CREATE OR REPLACE FUNCTION pgtapme.d_date_declarative_create_partitions( start_date date DEFAULT '1 jan 0001', end_date date DEFAULT '31 dec 0001' )
...
BEGIN
    ...
    LOOP
        ...
        EXECUTE FORMAT(
            $_$
                CREATE TABLE %I.%I PARTITION OF pgtapme.d_date_declarative
