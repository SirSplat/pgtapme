-- Verify pgtapme_dev:data/d_date_declarative_populate_partitions on pg
...
BEGIN
    ...
    SELECT COUNT("SQL Date") INTO v_count FROM pgtapme.d_date_declarative;
    ASSERT v_count = 365, 'Row count mismatch: expected 365, got: '|| v_count;

    SELECT MIN("SQL Date"), MAX("SQL Date") INTO v_min_date, v_max_date FROM pgtapme.d_date_declarative;
